...
OBJETOS = $(FONTES:.c=.o)
CFLAGS = -Iinclude -g -O3 -DGL_SILENCE_DEPRECATION -fopenmp #multithreading # -Wall -g  # Todas as warnings, infos de debug
...
Linux: $(OBJETOS)
	gcc $(OBJETOS) -O3 -lGL -lGLU -lglut -lm -fopenmp -o $(PROG)
